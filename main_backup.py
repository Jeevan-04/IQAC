...
def add_beautiful_global_styles():
    """Add comprehensive beautiful styling to the application"""
    ui.add_head_html('''
    <style>
    ...
    :root {
        ...
        --shadow-strong: 0 25px 45px rgba(31, 38, 135, 0.15);
...
def institution_admin_hierarchy(inst_id: str):
    ...
    # Add drag-and-drop CSS and JavaScript functionality
    ui.add_head_html('''
    <style>
    .draggable-program {
